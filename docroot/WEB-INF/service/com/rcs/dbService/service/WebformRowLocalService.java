...
/**
 * Provides the local service interface for WebformRow. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rikad.ramadhan@rotterdam-cs.com
 * @see WebformRowLocalServiceUtil
...
public interface WebformRowLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WebformRowLocalServiceUtil} to access the webform row local service. Add custom service methods to {@link com.rcs.dbService.service.impl.WebformRowLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
