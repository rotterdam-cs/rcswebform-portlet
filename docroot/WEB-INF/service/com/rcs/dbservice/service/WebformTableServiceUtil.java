...
public class WebformTableServiceUtil {
	...
	*/
	...
	public static WebformTableService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WebformTableService.class.getName());

			if (invokableService instanceof WebformTableService) {
				_service = (WebformTableService)invokableService;
			}
			else {
				_service = new WebformTableServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(WebformTableServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(WebformTableService service) {
	}

	private static WebformTableService _service;
}