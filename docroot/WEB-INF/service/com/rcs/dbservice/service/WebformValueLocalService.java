...
/**
 * Provides the local service interface for WebformValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author rikad.ramadhan@rotterdam-cs.com
 * @see WebformValueLocalServiceUtil
...
public interface WebformValueLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WebformValueLocalServiceUtil} to access the webform value local service. Add custom service methods to {@link com.rcs.dbservice.service.impl.WebformValueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
