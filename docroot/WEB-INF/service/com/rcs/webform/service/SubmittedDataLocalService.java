...
/**
 * Provides the local service interface for SubmittedData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ryusuf
 * @see SubmittedDataLocalServiceUtil
...
public interface SubmittedDataLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubmittedDataLocalServiceUtil} to access the submitted data local service. Add custom service methods to {@link com.rcs.webform.service.impl.SubmittedDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
