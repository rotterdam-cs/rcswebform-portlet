...
/**
 * Provides the local service interface for FormToPorletMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ryusuf
 * @see FormToPorletMapLocalServiceUtil
...
public interface FormToPorletMapLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FormToPorletMapLocalServiceUtil} to access the form to porlet map local service. Add custom service methods to {@link com.rcs.webform.service.impl.FormToPorletMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
